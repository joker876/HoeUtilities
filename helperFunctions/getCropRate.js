...
export default function getCropRate() {
    ...
    global.hoeutils.debug.croprate.stages.push(crop_rate); //0
    ...
    global.hoeutils.debug.croprate.stages.push(crop_rate); //1
    ...
    if (heldItem.getString('id').match(/HOE_CANE/)) {
        ...
        if (heldItem.getCompoundTag('enchantments').getInteger('turbo_potato')) {
            crop_rate += heldItem.getCompoundTag('enchantments').getInteger('turbo_potato') * 5;
        ...
        if (heldItem.getCompoundTag('enchantments').getInteger('turbo_carrot')) {
            crop_rate += heldItem.getCompoundTag('enchantments').getInteger('turbo_carrot') * 5;
        ...
        if (heldItem.getCompoundTag('enchantments').getInteger('turbo_wheat')) {
            crop_rate += heldItem.getCompoundTag('enchantments').getInteger('turbo_wheat') * 5;
        ...
        if (heldItem.getCompoundTag('enchantments').getInteger('turbo_warts')) {
            crop_rate += heldItem.getCompoundTag('enchantments').getInteger('turbo_warts') * 5;
        ...
        if (heldItem.getCompoundTag('enchantments').getInteger('turbu_pumpkin')) {
            crop_rate += heldItem.getCompoundTag('enchantments').getInteger('turbo_pumpkin') * 5;
        ...
        if (heldItem.getCompoundTag('enchantments').getInteger('turbo_melon')) {
            crop_rate += heldItem.getCompoundTag('enchantments').getInteger('turbo_melon') * 5;
